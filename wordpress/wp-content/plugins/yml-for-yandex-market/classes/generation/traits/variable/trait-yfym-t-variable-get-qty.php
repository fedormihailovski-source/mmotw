<?php
/**
 * Traits Qty for variable products
 *
...
trait YFYM_T_Variable_Get_Qty {
	...
	public function get_qty( $tag_name = 'qty', $result_xml = '' ) {
		...
		if ( $yfym_qty === 'enabled' ) {
			if ( true == $this->get_offer()->get_manage_stock() ) { // включено управление запасом на уровне вариации
