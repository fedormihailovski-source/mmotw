...
class WCTLR_Admin_Notices {
	...
	private function __construct( $plugin_file = null ) {
		...
		$convert_exists_slugs_url = wp_nonce_url( add_query_arg( 'wctlr_convert_existing_slugs', '' ), 'convert_exising_slugs' );
			...
			$this->suggestions_message .= 'If something went wrong, you can rollback converted slugs with the <a href="https://wordpress.org/plugins/cyrlitera/" target="_blank">Cyrlitera</a> plugin or contact with our <a href="https://wordpress.org/support/plugin/cyr-and-lat/" target="_blank" rel="noopener">support team</a>, we will definitely help you. ';
