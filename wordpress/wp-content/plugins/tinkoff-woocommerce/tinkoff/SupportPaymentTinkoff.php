...
class SupportPaymentTinkoff
{
    ...
    public static function send_data($order, $order_id)
    {
        ...
        $description = self::description_tinkoff($arrCartItems);
    ...
    public static function description_tinkoff($arrCartItems)
    {
        $strDescription = '';
